...
class FixNgCodecTest {
    ...
    @CsvSource(
        ...
        "2025-09-29T14:07:50.000000000,20250929-14:07:50.000000000,298,082",
        "2025-09-29T14:07:00.000000000,20250929-14:07:00.000000000,298,077",
        "2025-09-29T14:10:00.000000000,20250929-14:10:00.000000000,298,071",
        "2025-09-29T10:00:00.000000000,20250929-10:00:00.000000000,298,066",
        "2025-09-29T00:00:00.000000000,20250929-00:00:00.000000000,298,065",
    ...
    fun `encode local date time value with trailing zeros`(
        ...
        parsedBody["TransactTime"] = isoValue
        encodeTest(
            MSG_CORRECT
                .replace("60=20180205-10:38:08.000008", "60=${fixValue}")
                .replace("9=295", "9=${length}")
                .replace("10=191", "10=${checkSum}"),
            dirtyMode = false,
            '',
    ...
    @CsvSource(
        ...
        "2025-09-29T14:07:53.123450,20250929-14:07:53.12345,294,160",
        "2025-09-29T14:07:53.123400,20250929-14:07:53.1234,293,106",

        "2025-09-29T14:07:53.120,20250929-14:07:53.12,291,001",
        "2025-09-29T14:07:53.100,20250929-14:07:53.1,290,206",

        "2025-09-29T14:07:53,20250929-14:07:53,288,118",
    )
    fun `decode local date time value with trailing zeros`(
        isoValue: String,
        fixValue: String,
        length: Int,
        checkSum: String,
        ...
        with(parsedMessage) {
            (body map "header").set("BodyLength", length.toString())
            (body map "trailer").set("CheckSum", checkSum)
            body.set("TransactTime", isoValue)
