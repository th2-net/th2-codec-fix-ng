...
class FixNgCodecTest {
    ...
    fun `tags with 0 prefix decode (dirty)`(delimiter: Char) {
        with(parsedMessage) {
            ...
            (body map "trailer").set("CheckSum", "101")
            decodeTest(
                MSG_WITH_0_PREFIX,
                dirtyMode = true,
                delimiter = delimiter,
                ...
                expectedErrors = listOf(
                    ...
                    "Tag with zero prefix at offset: 321, raw: '...010=101${delimiter}'",
                    "Tag with zero prefix at offset: 321, raw: '...010=101${delimiter}'",
                    "Tag with zero prefix at offset: 321, raw: '...010=101${delimiter}'",
                    // CheckSum warning happens more than ones because it is read several times:
